...
public class Point implements Comparable<Point> {
    ...
    public static void main(String[] args) {
        ...
        StdOut.println(p1.compareTo(new Point(2, 1)));
        StdOut.println(p1.compareTo(new Point(-1, 1)));
        StdOut.println(p1.compareTo(new Point(1, 1)));

        StdOut.println(p1.slopeTo(p2));
        StdOut.println(p1.slopeTo(p1));
        StdOut.println(p1.slopeTo(new Point(2, 1)));
        StdOut.println(p1.slopeTo(new Point(1, 2)));

        StdOut
                .println(p1.slopeOrder().compare(new Point(1, 2), new Point(2, 1)));
        StdOut
                .println(p1.slopeOrder().compare(new Point(2, 1), new Point(1, 2)));
        StdOut
                .println(p1.slopeOrder().compare(new Point(1, 1), new Point(1, 1)));
